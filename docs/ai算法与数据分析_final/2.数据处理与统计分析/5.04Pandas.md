...
0 2018-02-27 23.53 1 2018-02-26 22.80 2 2018-02-23 22.88 3 2018-02-22 22.25 4 2018-02-14 21.49 5 2018-02-13 21.40 6 2018-02-12 20.70 7 2018-02-09 21.20 8 2018-02-08 21.79 9 2018-02-07 22.69
...
![](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E6%96%B0%E9%97%BB%E6%A0%87%E9%A2%98%E8%AE%BD%E5%88%BA%E8%AF%BB%E5%8F%96.png)
...
![缺失值](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E7%BC%BA%E5%A4%B1%E5%80%BC.png)
...
989 Martyrs Horror A young woman's quest for revenge against the ... Pascal Laugier Morjana Alaoui, Mylene Jampanoi, Catherine Beg... 2008 99 7.1 63785 NaN 89.0 990 Selma Biography,Drama,History A chronicle of Martin Luther King's campaign t... Ava DuVernay David Oyelowo, Carmen Ejogo, Tim Roth, Lorrain... 2014 128 7.5 67637 52.07 NaN
...
![问号缺失值](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E9%97%AE%E5%8F%B7%E7%BC%BA%E5%A4%B1%E5%80%BC.png)
...
连续属性离散化的目的是为了简化数据结构， **数 据离散化技术可以用来减少给定连续属性值的个数** 。离散化方法经常作为数据挖掘的工具。

## 2 什么是数据的离散化

**连 续属性的离散化就是在连续属性的值域上，将值域划分为若干个离散的区间，最后用不同的符号或整数** **值 代表落在每个子区间中的属性值。**
...
![哑变量矩阵](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%93%91%E5%8F%98%E9%87%8F%E7%9F%A9%E9%98%B5.png)
...
![股票涨跌幅分组](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E8%82%A1%E7%A5%A8%E6%B6%A8%E8%B7%8C%E5%B9%85%E5%88%86%E7%BB%84.png)
...
bins = [-100, -7, -5, -3, 0, 3, 5, 7, 100] p_counts = pd.cut(p_change, bins)
...
![image-20190316224151504](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/one_hot%E7%BC%96%E7%A0%81.png)
...
![股票哑变量合并](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E8%82%A1%E7%A5%A8%E5%93%91%E5%8F%98%E9%87%8F%E5%90%88%E5%B9%B6.png)
...
![内连接](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%86%85%E8%BF%9E%E6%8E%A5.png)
...
![左连接](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%B7%A6%E8%BF%9E%E6%8E%A5.png)
...
![右连接](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%8F%B3%E8%BF%9E%E6%8E%A5.png)
...
![外链接](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%A4%96%E9%93%BE%E6%8E%A5.png)
...
**以 下图当中表示，week代表星期几，1,0代表这一天股票的涨跌幅是好还是坏，里面的数据代表比例**

**可 以理解为所有时间为星期一等等的数据当中涨跌幅好坏的比例**

![交叉表透视表作用](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E4%BA%A4%E5%8F%89%E8%A1%A8%E9%80%8F%E8%A7%86%E8%A1%A8%E4%BD%9C%E7%94%A8.png)

![crosstab](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/crosstab.png)

## 2 使用crosstab(交叉表)实现上图

  * 交叉表： **交 叉表用于计算一列数据对于另外一列数据的分组个数(寻找两个列之间的关系)**
...
date = pd.to_datetime(data.index).weekday data['week'] = date
...
**分 组与聚合通常是分析数据的一种方式，通常与一些统计函数一起使用，查看数据的分组情况**

想一想其实刚才的交叉表与透视表也有分组的功能，所以算是分组的一种形式，只不过他们主要是计算次数或者计算比例！！看其中的效果：

![分组效果](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%88%86%E7%BB%84%E6%95%88%E6%9E%9C.png)

## 1 什么分组与聚合

![分组聚合原理](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%88%86%E7%BB%84%E8%81%9A%E5%90%88%E5%8E%9F%E7%90%86.png)
...
col.groupby(['color'])['price1'].mean() col['price1'].groupby(col['color']).mean()

color green 2.025 red 2.380 white 5.560 Name: price1, dtype: float64
...
![星巴克数据](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E6%98%9F%E5%B7%B4%E5%85%8B%E6%95%B0%E6%8D%AE.png)
...
![星巴克数量画图](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E6%98%9F%E5%B7%B4%E5%85%8B%E6%95%B0%E9%87%8F%E7%94%BB%E5%9B%BE.png)
...
![国家省市分组结果](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E5%9B%BD%E5%AE%B6%E7%9C%81%E5%B8%82%E5%88%86%E7%BB%84%E7%BB%93%E6%9E%9C.png)

**仔 细观察这个结构，与我们前面讲的哪个结构类似？？**
...
**现 在我们有一组从2006年到2016年1000部最流行的电影数据，数据来源：https://www.kaggle.com/damianpanek/sunday- eda/data**
...
**我 们想知道这些电影数据中评分的平均分，导演的人数等信息，我们应该怎么获取？**
...
**对 于这一组电影数据，如果我们想Rating，Runtime (Minutes)的分布情况，应该如何呈现数据？**
...
![](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E7%94%B5%E5%BD%B1%E5%88%86%E6%95%B0%E7%9B%B4%E6%96%B9%E5%9B%BE.png)
...
![](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E7%94%B5%E5%BD%B1%E5%88%86%E6%95%B0%E7%9B%B4%E6%96%B9%E5%9B%BE1.png)
...
![](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/%E7%94%B5%E5%BD%B1%E5%88%86%E6%95%B0%E7%9B%B4%E6%96%B9%E5%9B%BE2.png)

### 2.3 问题三：

**对 于这一组电影数据，如果我们希望统计电影分类(genre)的情况，应该如何处理数据？**
...
Musical 5.0 Western 7.0 War 13.0 Music 16.0 Sport 18.0 History 29.0 Animation 49.0 Family 51.0 Biography 81.0 Fantasy 101.0 Mystery 106.0 Horror 119.0 Sci-Fi 120.0 Romance 141.0 Crime 150.0 Thriller 195.0 Adventure 259.0 Comedy 279.0 Action 303.0 Drama 513.0 dtype: float64


![](http://cyc.chenyangstudy.cn/book_chenyang/a01数据处理与统计分析/images/genre%E5%88%86%E7%B1%BB%E7%BB%93%E6%9E%9C.png)